...
urlpatterns = [
    ...
    url(r'^categoria_criada/$', controle.categoriaCriada, name="categoria_criada"),
    url(r'^conta_criada/$', controle.contaCriada, name="conta_criada"),
    ...
    url(r'^deletar_categoria/(?P<pk>\d+)$', controle.deletarCategoria, name="deletar_categoria")
]